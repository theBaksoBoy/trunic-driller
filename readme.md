...
- probably just ask the Discord how to compile to different platforms. Say that you use Linux on x86_64, and want to compile to at least 64bit windows and ARM linux, and that if it isn't a pain in the ass then other platforms would also be good. Ask how feasible this is to do. .exe files store the icon in them right? Ask how that is assigned
