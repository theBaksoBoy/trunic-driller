...
sentence_collection: []StringSet = {
    ...
    {"The migration to Arch Linux is more involved than I would have hoped for...", "MZ mIgrBSZn tU GrtS linZks iz mR invGlvd Man I wLd hav hopt fR..."},
    {"I should continue with writing Cotton\'s logbook soon huh?", "I SLd kZntinjU wiM rItiN kGtZnz lGgbLk sUn hZ?"},
    {"Always look a thousand times in each direction before crossing the street!", "GlwBz lLk B TWzZn tImz in FtS dIrekSin bFfR krGsiN MZ strFt!"},
    ...
    {"The age of Arch Linux is quickly approaching... maybe.", "MZ By Zv GrtS linZks iz kwiklF ZprotSiN... mBbF."},
    ...
    {"Compiling this program on Windows is such a pain in the ass.", "kZmpIliN Mis program Gn windoz iz sZtS B pBn in MZ as."},
    ...
    {"Good that I\'m in sandbox-mode so that I can actually save her more easily.", "gLd Mat Im in sandbGks-mod so Mat I kan aktSUZlF sBv hV mR FzZlF."},
    ...
    {"It\'s interesting seeing how much everyone\'s sentences differ in style.", "its intVZstiN sFiN hW mZtS evrFwZnz sentZnsZz difV in stIl."},
    ...
    {"This makes it way more nonsensical when actually using the program.", "Mis mBks it wB mR nGnsensikZl hwen aktSUZlF jUziN MZ program."},
