...
sentence_collection: []StringSet = {
    ...
    {"Thanks for watching! Remember to like and subscribe!", "TaNks fR wGtSiN! rFmembV tU lIk and sZbskrIb!"},
    ...
    {"Getting my launchpad to work with my DAW was a nightmare.", "getiN mI lGntSpad tU wVk wiM mI dG wGz B nItmE."},
    ...
    {"I wish that I was rich so that I could tip artists a gazillion moneys.", "I wiS Mat I wGz ritS so Mat I kLd tip Grtists B gZziljZn mZnFz."},
